...
namespace sibr {
	...
	protected:
		...
		torch::jit::script::Module contri_mlp_module;
		torch::jit::script::Module shobj_mlp_module;
		...
		std::vector<float> anchor_contri;
		std::vector<float> anchor_seg;
		...
		torch::Tensor ak_contri_all;
		torch::Tensor ak_seg_all;
